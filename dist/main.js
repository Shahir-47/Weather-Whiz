...
/* harmony export */   showDayTab: () => (/* binding */ showDayTab),
/* harmony export */   showHourlyTab: () => (/* binding */ showHourlyTab)
/* harmony export */ });
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/parse/index.js");
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/compareAsc/index.js");
...
/* harmony import */ var _img_sunsetIcon_svg__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../img/sunsetIcon.svg */ "./src/img/sunsetIcon.svg");
/* harmony import */ var _img_morning_svg__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../img/morning.svg */ "./src/img/morning.svg");
...
function createHourlyCard(data, unit) {
  ...
  var now = (0,date_fns__WEBPACK_IMPORTED_MODULE_20__["default"])(data.location.localtime.slice(11, 16), "HH:mm", new Date());
  var index = 0;
  var totalCards = 0;
  var currentTemp;
  if (unit === "imperial") {
  ...
  data.forecast.forecastday[0].hour.every(function (hour, i) {
    var time = (0,date_fns__WEBPACK_IMPORTED_MODULE_20__["default"])(hour.time.slice(11, 16), "HH:mm", new Date());
    if ((0,date_fns__WEBPACK_IMPORTED_MODULE_21__["default"])(now, time) === -1) {
      index = i;
      return false;
    }
    return true;
  });
  forecastSlider.appendChild(makeHourlyCard("Now", "./img/weather/".concat(data.current.condition.icon.slice(29)), "".concat(currentTemp), data.current.condition.text, "".concat(data.forecast.forecastday[0].day.daily_chance_of_rain, "%"), "".concat(data.forecast.forecastday[0].day.daily_chance_of_snow, "%")));
  totalCards += 1;
  for (var i = index; i < 24; i += 1) {
    ...
    var sunriseTime = (0,date_fns__WEBPACK_IMPORTED_MODULE_20__["default"])(data.forecast.forecastday[0].astro.sunrise, "h:mm a", new Date());
    var sunsetTime = (0,date_fns__WEBPACK_IMPORTED_MODULE_20__["default"])(data.forecast.forecastday[0].astro.sunset, "h:mm a", new Date());
    var time = data.forecast.forecastday[0].hour[i].time.slice(11, 16);
    var timeFormat = (0,date_fns__WEBPACK_IMPORTED_MODULE_20__["default"])(time, "HH:mm", new Date());
    var nextTime = data.forecast.forecastday[0].hour[nextIndex].time.slice(11, 16);
    var nextTimeFormat = (0,date_fns__WEBPACK_IMPORTED_MODULE_20__["default"])(nextTime, "HH:mm", new Date());
    ...
    totalCards += 1;
    if ((0,date_fns__WEBPACK_IMPORTED_MODULE_21__["default"])(sunriseTime, timeFormat) === 1 && (0,date_fns__WEBPACK_IMPORTED_MODULE_21__["default"])(nextTimeFormat, sunriseTime) === 1 && nextIndex !== 0) {
      forecastSlider.appendChild(createAstroCard(data.forecast.forecastday[0].astro.sunrise, _img_morning_svg__WEBPACK_IMPORTED_MODULE_19__, "Sunrise"));
    } else if ((0,date_fns__WEBPACK_IMPORTED_MODULE_21__["default"])(sunsetTime, timeFormat) === 1 && (0,date_fns__WEBPACK_IMPORTED_MODULE_21__["default"])(nextTimeFormat, sunsetTime) === 1 && nextIndex !== 0) {
      forecastSlider.appendChild(createAstroCard(data.forecast.forecastday[0].astro.sunset, _img_sunsetIcon_svg__WEBPACK_IMPORTED_MODULE_18__, "Sunset"));
    }
  }
  console.log(totalCards);
  for (var _i2 = 0; _i2 < 26 - totalCards; _i2 += 1) {
    var _nextIndex = _i2 + 1;
    if (_nextIndex === 24) {
      _nextIndex = 0;
    }
    var _time = data.forecast.forecastday[1].hour[_i2].time.slice(11, 16);
    var _sunriseTime = (0,date_fns__WEBPACK_IMPORTED_MODULE_20__["default"])(data.forecast.forecastday[1].astro.sunrise, "h:mm a", new Date());
    var _sunsetTime = (0,date_fns__WEBPACK_IMPORTED_MODULE_20__["default"])(data.forecast.forecastday[1].astro.sunset, "h:mm a", new Date());
    var _timeFormat = (0,date_fns__WEBPACK_IMPORTED_MODULE_20__["default"])(_time, "HH:mm", new Date());
    var _nextTime = data.forecast.forecastday[1].hour[_nextIndex].time.slice(11, 16);
    var _nextTimeFormat = (0,date_fns__WEBPACK_IMPORTED_MODULE_20__["default"])(_nextTime, "HH:mm", new Date());
    var _iconImage = "./img/weather/".concat(data.forecast.forecastday[1].hour[_i2].condition.icon.slice(29));
    var _temperature = void 0;
    if (unit === "imperial") {
      _temperature = "".concat(data.forecast.forecastday[1].hour[_i2].temp_f, " \xB0F");
    } else {
      _temperature = "".concat(data.forecast.forecastday[1].hour[_i2].temp_c, " \xB0C");
    }
    var _condition = data.forecast.forecastday[1].hour[_i2].condition.text;
    var _rainChance = "".concat(data.forecast.forecastday[1].hour[_i2].chance_of_rain, "%");
    var _snowChance = "".concat(data.forecast.forecastday[1].hour[_i2].chance_of_snow, "%");
    forecastSlider.appendChild(makeHourlyCard(_time, _iconImage, _temperature, _condition, _rainChance, _snowChance));
    if ((0,date_fns__WEBPACK_IMPORTED_MODULE_21__["default"])(_sunriseTime, _timeFormat) === 1 && (0,date_fns__WEBPACK_IMPORTED_MODULE_21__["default"])(_nextTimeFormat, _sunriseTime) === 1 && _nextIndex !== 0) {
      forecastSlider.appendChild(createAstroCard(data.forecast.forecastday[0].astro.sunrise, _img_morning_svg__WEBPACK_IMPORTED_MODULE_19__, "Sunrise"));
    } else if ((0,date_fns__WEBPACK_IMPORTED_MODULE_21__["default"])(_sunsetTime, _timeFormat) === 1 && (0,date_fns__WEBPACK_IMPORTED_MODULE_21__["default"])(_nextTimeFormat, _sunsetTime) === 1 && _nextIndex !== 0) {
      forecastSlider.appendChild(createAstroCard(data.forecast.forecastday[0].astro.sunset, _img_sunsetIcon_svg__WEBPACK_IMPORTED_MODULE_18__, "Sunset"));
    }
  }
  console.log(totalCards);
...
function buttons() {
  ...
  var scrollStep = 5.75; // Adjust this value to control the smoothness of the scroll
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 6:
          ...
          unit = document.getElementById("unit-toggle").checked ? "metric" : "imperial";
          displayWeatherData(weatherData, unit);
          if (document.querySelector("input[name='forecast']:checked").value === "day") {
...
document.querySelector("#hourly").addEventListener("change", function () {
  if (document.querySelector("#hourly").checked) {
    (0,_js_UI__WEBPACK_IMPORTED_MODULE_2__.showHourlyTab)();
...
document.getElementById("unit-toggle").addEventListener("change", function () {
  (0,_js_UI__WEBPACK_IMPORTED_MODULE_2__.changeUnits)();
});
document.querySelector("#day").addEventListener("change", function () {
  if (document.querySelector("#day").checked) {
    ...
    (0,_js_UI__WEBPACK_IMPORTED_MODULE_2__.showDayTab)();
  }
});
})();
