...
function createHourlyCard(data) {
  ...
  for (var _i2 = 0; _i2 < 26 - totalCards; _i2 += 1) {
    ...
    var _temperature = "".concat(data.forecast.forecastday[1].hour[_i2].temp_f, " \xB0F");
...
function buttons() {
  ...
  var scrollStep = 6; // Adjust this value to control the smoothness of the scroll
